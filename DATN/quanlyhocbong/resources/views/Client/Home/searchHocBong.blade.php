                    ...
                    <a href="{{URL::to('/chitiet-hocbong/'.$hocbong->hocbong_id)}}">
                        <div class="card shadow h-100">
                            ...
                            <div class="card-content h-100">
                                ...
                                <!-- <p class="total-register"><i class="fas fa-user-graduate"></i>Tổng số lượng : 20</p>
                                            <p class="registered-quantity"><i class="fas fa-user-graduate"></i>Số lượng đã đăng kí: 10</p> -->
                            </div>
