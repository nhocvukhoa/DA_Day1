            ...
            <table class="table table-bordered" id="loaihocbong_table" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::to('/edit-tieuchi/'.$item->tieuchi_id)}}" class="btn btn-success text-uppercase" title="Sửa">
                                <i class="bi bi-pen "></i>
                            </a>
                            <a href="{{URL::to('/delete-tieuchi/'.$item->tieuchi_id)}}" class="btn btn-danger text-uppercase delete" 
