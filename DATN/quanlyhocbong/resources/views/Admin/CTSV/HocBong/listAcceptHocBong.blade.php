            ...
            <table class="table table-bordered" id="loaihocbong_table" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::to('/active-hocbong/'.$hocbong->hocbong_id)}}" class="btn btn-success text-uppercase" title="Duyệt">
                                <i class="bi bi-check2-circle"></i>
                            </a>
                            <a href="{{URL::to('/detail-accept-hocbong/'.$hocbong->hocbong_id)}}" class="btn btn-info text-uppercase detail" title="Xem chi tiết">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{URL::to('/delete-accept-hocbong/'.$hocbong->hocbong_id)}}" class="btn btn-danger text-uppercase  delete" 
