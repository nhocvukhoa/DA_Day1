    ...
    <div class="card-body">
        ...
        <form action="">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <p class="mb-0">{{$detail->hocbong_thoigianbatdau}}</p>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3">Thời gian kết thúc :</label>
                <div class="col-sm-9">
                    <p class="mb-0">{{$detail->hocbong_thoigianketthuc}}</p>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label class="col-sm-3">Người duyệt :</label>
                <div class="col-sm-9">
                    <p class="mb-0">{{$detail->hocbong_nguoiduyet}}</p>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label class="col-sm-3">Thời gian duyệt :</label>
                <div class="col-sm-9">
                    <p class="mb-0">{{$detail->hocbong_ngayduyet}}</p>
                </div>
            </div>
            <hr>
            <a href="{{URL::to('list-accept-hocbong')}}" class="btn btn-danger mt-2">Quay lại</a>
        </form>
        @endforeach
    </div>
</div>
