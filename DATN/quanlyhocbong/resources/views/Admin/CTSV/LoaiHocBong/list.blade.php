                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('delete_loaihocbong', $loaihb->loaihocbong_id)}}" class="btn btn-danger text-uppercase delete" 
                            title="Xóa" onclick="return confirm('Bạn có muốn xóa loại học bổng này không?')"">
