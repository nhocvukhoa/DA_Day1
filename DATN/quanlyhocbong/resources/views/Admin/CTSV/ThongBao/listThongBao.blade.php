        ...
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{URL::to('add-thongbao')}}" class="btn btn-primary text-uppercase" title="Thêm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{asset('public/Upload/ThongBao/'.$item->thongbao_file)}}">
                                Xem file
                            </a>
                            @else
                        ...
                        <td>{{ $item->thongbao_thoigiandang }}</td>
                        <td>{{ $item->fullname }}</td>
                        <td>
                            <a href="{{URL::to('/edit-thongbao/'.$item->thongbao_id)}}" class="btn btn-success text-uppercase mb-1 edit" title="Sửa">
                                <i class="bi bi-pen"></i>
                            </a>
                            <a href="{{URL::to('/delete-thongbao/'.$item->thongbao_id)}}" class="btn btn-danger text-uppercase delete mb-1" title="Xóa" 
