...
class HocBong extends Model
{
    ...
    protected $fillable = [
        'loaihocbong_id', 'hocky_id', 'hocbong_ten', 'hocbong_hinhanh', 'hocbong_noidung', 'hocbong_thoigianbatdau',
        'hocbong_thoigianketthuc', 'hocbong_kinhphi', 'hocbong_tongsoluong', 'hocbong_soluongdadangky',
        'hocbong_tinhtrang', 'hocbong_nguoiduyet', 'user_id', 'hocbong_ngayduyet'
    ];
