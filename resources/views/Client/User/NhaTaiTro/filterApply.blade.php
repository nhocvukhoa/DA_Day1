                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dangkyhocbong_data" width="100%" cellspacing="0">
                        <div class="d-flex justify-content-end mb-3 align-items-center">
                            ...
                            <form action="{{route('return.apply_dshocbong',['hocbong_id' => $hocbong_id])}}" method="GET">
                            ...
                            <tr>
                                ...
                                <td class="col-md-2">
                                    ...
                                    @if($total < $user->hocbong_tongsoluong)
                                        ...
                                        @else
                                        <a href="{{route('apply_accept_hocbong_ntt_filter',['dangky_id' => $user->dangky_id])}}" class="btn btn-danger text-uppercase mb-1 detail" title="Xem hồ sơ">
                                            Duyệt
                                        </a>
                                        @endif
                                        @else
